...
class StreamerProfile(models.Model):
    ...
    last_live_time = models.DateField(auto_now=True, null=True)
...
class StreamCategory(models.Model):
    ...
    title = models.CharField(unique=True, max_length=25, blank=False)
    color_hex = models.CharField(default='#c94035')
