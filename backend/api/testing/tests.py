...
class TestApi(TestCase):
    ...
    def test_F_auth_check_auth_false(self):
        self.response = self.session.get(
            f"{settings.BASE_URL}/api/auth/checkAuth/")
        response_body = self.response.json()
    ...
    def test_M_posts_get_user_posts(self):
        self.response = self.session.get(
            f"{settings.BASE_URL}/api/posts/getUserPosts/?user_id={test_user_one['user_id']}&limit=5")
        response_body = self.response.json()
        self.assertEqual(self.response.status_code, HTTP_STATUS["OK"])
    ...
    def test_N_posts_get_single_post(self):
        self.response = self.session.get(
            f"{settings.BASE_URL}/api/posts/getSinglePost/{test_post_video['post_id']}/")
        response_body = self.response.json()
        self.assertEqual(self.response.status_code, HTTP_STATUS["OK"])
        self.assertTrue(response_body['success'])
        self.assertEqual(
    ...
    def test_Q_delete_post(self):
        self.response = self.session.delete(
            f"{settings.BASE_URL}/api/posts/deletePost/{test_post_image['post_id']}/")
        response_body = self.response.json()
        self.assertEqual(self.response.status_code, HTTP_STATUS["OK"])
        self.assertTrue(response_body['success'])
        self.assertEqual(response_body['message'],
    ...
    def test_S_posts_get_single_post_not_exist(self):
        self.response = self.session.get(
            f"{settings.BASE_URL}/api/posts/getSinglePost/{test_post_image['post_id']}/")
        response_body = self.response.json()
    ...
    def test_V_posts_get_bookmarks(self):
        self.response = self.session.get(
            f"{settings.BASE_URL}/api/posts/getBookmarkedPosts/")
        response_body = self.response.json()
        self.assertEqual(self.response.status_code, HTTP_STATUS["OK"])
        self.assertTrue(response_body['success'])
    ...
    def test_W_posts_delete_bookmark(self):
        self.response = self.session.delete(
            f"{settings.BASE_URL}/api/posts/deletePostBookmark/{test_post_text['post_id']}/")
        response_body = self.response.json()
        self.assertEqual(self.response.status_code, HTTP_STATUS["OK"])
        self.assertTrue(response_body['success'])
        self.assertEqual(response_body['message'],
    ...
    def test_Z_auth_logout(self):
        self.response = self.session.post(
            f"{settings.BASE_URL}/api/auth/logout/")
        response_body = self.response.json()
        self.assertEqual(self.response.status_code, HTTP_STATUS["OK"])
        self.assertTrue(response_body['success'])
